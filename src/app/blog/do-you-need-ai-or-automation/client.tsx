...
interface DoYouNeedAIOrAutomationClientProps {
  post: BlogPostMetadata;
}

const DoYouNeedAIOrAutomationClient = ({ post }: DoYouNeedAIOrAutomationClientProps) => {
  return (
...
export default DoYouNeedAIOrAutomationClient;
